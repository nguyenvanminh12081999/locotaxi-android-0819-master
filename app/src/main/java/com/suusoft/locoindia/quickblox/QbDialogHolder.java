...
public class QbDialogHolder {
    ...
    public QBChatDialog getChatDialogById(String dialogId){
        if (dialogsMap!=null){
            Log.e("getChatDialogById", "dialogsMap!=null");
            if (dialogsMap.get(dialogId)!=null){
                Log.e("getChatDialogById", "dialogsMap.get(dialogId)!=null");
                return dialogsMap.get(dialogId);
            }else {
                Log.e("getChatDialogById", "dialogsMap.get(dialogId)==null");
                return new QBChatDialog();
            }
    ...
    public void updateDialog(String dialogId, QBChatMessage qbChatMessage){
        Log.e("getChatDialogById", "QbDialogHolder updateDialog");
