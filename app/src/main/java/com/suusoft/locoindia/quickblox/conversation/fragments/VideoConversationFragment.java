...
import com.suusoft.locoindia.quickblox.adapters.OpponentsFromCallAdapter;
...
//        }
    ...
    protected void initViews(View view) {
        ...
        if (!isPeerToPeerCall) {
            ...
            recyclerView.addItemDecoration(new DividerItemDecoration(getActivity(), R.dimen.dimen_divider));
...
//          for correct removing item in adapter
    ...
    private void setGrid(int columnsCount) {
        ...
        float itemMargin = getResources().getDimension(R.dimen.dimen_divider);
...
//            actionBar.show();
        ...
        private void shiftMarginListOpponents() {
            ...
            params.setMargins(0, 0, 0, (int) getResources().getDimension(R.dimen.dimen_2x));
