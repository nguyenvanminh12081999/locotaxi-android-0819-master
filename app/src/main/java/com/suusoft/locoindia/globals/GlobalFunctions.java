...
import com.suusoft.locoindia.MySharedPreferences;
...
/**
 * Created by SuuSoft.com on 12/01/2015.
 */
public class GlobalFunctions {
    ...
    public static void showConfirmationDialog(Context context, String msg, String positive, String negative,
        ...
        TextViewBold lblNegative = (TextViewBold) dialog.findViewById(R.id.lbl_negative);
        TextViewBold lblPositive = (TextViewBold) dialog.findViewById(R.id.lbl_positive);
    ...
    public static boolean isTheFirstMessage(TransportDealObj transportDealObj) {
        ...
        if (obj != null) {
            if (obj.getDriverId().equals(transportDealObj.getDriverId())
