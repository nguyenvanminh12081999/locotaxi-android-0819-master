...
import com.suusoft.locoindia.quickblox.QbSessionStateCallback;
import com.suusoft.locoindia.quickblox.SharedPreferencesUtil;
import com.suusoft.locoindia.quickblox.chat.ChatHelper;
import com.suusoft.locoindia.quickblox.manager.DialogsManager;
        ...
        ChatHelper.getInstance().createDialogWithSelectedUsers(selectedUsers,
                new QBEntityCallback<QBChatDialog>() {
                    ...
                    public void onSuccess(QBChatDialog dialog, Bundle args) {
                        ...
                        ChatActivityBySuusoft.start(self, dialog.getDialogId(), obj);
