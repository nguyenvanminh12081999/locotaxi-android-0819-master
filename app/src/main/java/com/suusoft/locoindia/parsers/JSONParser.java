package com.suusoft.locoindia.parsers;
...
import com.suusoft.locoindia.objects.RevenueObj;
        ...
        try {
            ...
            if (datum.length() > 0) {
                for (int i = 0; i < datum.length(); i++) {
                    ...
                    Log.e("json", "TransportDealObj = " + jsonObject.toString()  );
        ...
        try {
            ...
            if (datum.length() > 0) {
                for (int i = 0; i < datum.length(); i++) {
                    ...
                    transportDealObj.setPassengerId(obj.optString(PASSENGER_ID));
