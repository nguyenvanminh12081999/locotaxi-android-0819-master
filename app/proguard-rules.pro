...
#-------My Class ------------------------
-keep class com.suusoft.taxinear.objects.** { *; }
-keep class com.suusoft.taxinear.base.** { *; }
-keep class com.suusoft.taxinear.network1.** { *; }
-keep class com.suusoft.taxinear.network.** { *; }
-keep class * extends com.suusoft.taxinear.base.BaseActivity { *; }
-keep class * extends com.suusoft.taxinear.base.BaseFragment { *; }
...
-repackageclasses com.suusoft.taxinear
